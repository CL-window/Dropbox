...
//                         val exListView: ExRecyclerView,
//                         val pageCallback: PageController.PageCallback) {
//    init {
//        refreshLayout.setOnRefreshListener { refresh() }
//
//        exListView.setOnLoadMoreListener {
...
//    }
//
//    private val pageCtrl: PageController by lazy { PageController(callback) }
//
//    private val callback = object : PageController.PageCallback {
//        override fun onLoading(page: Int) {
//            if (pageCtrl.isRefreshing() && !refreshLayout.isRefreshing) {
//                refreshLayout.post({ refreshLayout.isRefreshing = true })
//            }
//            else {
//                showLoading()
...
//
//    fun loadMore() = pageCtrl.loadMore()
//
//    fun finish(result: PageController.Result) {
//        if (pageCtrl.isRefreshing()) {
//            when (result) {
//                PageController.Result.SUCCESS -> {
//                    if (!exListView.containsFooter(footer))
//                        exListView.addFooter(footer)
...
//        noMore.visibility = View.GONE
//
//        reload.findViewById(R.id.btn).setOnClickListener({ pageCtrl.loadMore() })
//    }
//
//    private fun showNoMore() {
//        loading.visibility = View.GONE
...
//
//    /**
//     * handler loading, reload , no more, etc action
//     * TODO: 分离 footer
//     */
